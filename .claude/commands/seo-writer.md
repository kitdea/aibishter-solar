...
- A **cluster name** (e.g. "residential") → you will write a new blog post targeting that cluster
- A **page slug** (e.g. "services/commercial-solar") → you will rewrite existing page content
...
- Service area pages: `src/app/service-areas/[slug]/page.tsx`
