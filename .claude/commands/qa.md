...
| 11 | Local signal | At least one mention of a location (Lucena, Quezon, Philippines, Calabarzon, Southern Luzon) |
| 12 | CTA present | Last paragraph includes a call to action (contact, call, get a quote, free estimate) |
...
If `memory/seo/qa-log.md` does not exist, create it with this header:

```
# QA Log

| Date | Page/Topic | Result | Failed Checks | Notes |
|------|-----------|--------|---------------|-------|
```
