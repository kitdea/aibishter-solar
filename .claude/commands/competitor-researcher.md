...
- `memory/seo/keywords.md` — keywords Aibishter Solar already targets

## Step 2: Identify Competitor Domains

The domain(s) are the argument(s) passed to this skill (e.g. "example-solar.com", "domain1.com domain2.com").
...
## Step 4: Filter to Solar-Relevant Keywords

Keep only keywords relevant to solar energy or related home/commercial energy services. Drop:
- Brand name keywords (containing the competitor's company name)
- Unrelated keywords (generic home improvement unrelated to solar)
...
If `memory/seo/competitors.md` does not exist, create it with this header:
...
Append new rows for all solar-relevant keywords from this run:
```
