            ...
            <div className="flex flex-col space-y-4">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-2xl font-bold text-slate-900 dark:text-white hover:text-accent-blue transition-colors pb-4 border-b border-slate-100 dark:border-slate-800 line-clamp-1"
