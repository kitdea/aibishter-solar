...
export default function DOEBadgeMarquee() {
  return (
    <div className="w-full overflow-hidden py-5 border-y border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 mb-14 md:mb-24">
      <div className="flex animate-marquee whitespace-nowrap">
        {ITEMS.flatMap((prefix) =>
          REPEAT.map((_, i) => (
            <span key={`${prefix}-${i}`} className="inline-flex items-center gap-3 mx-12 shrink-0">
